...
/**
 * A class that manages a MediaPlayer object, while this class is run through the Java.util.UnnamedApplication thread
 * @author Javier Sarria Bastidas
 * @version W2
 */
public class UnnamedMediaPlayerHolder extends Observable implements Runnable
{
     ...
     */
    public UnnamedMediaPlayerHolder(boolean debug) {
        this.debug = debug;
        songName = "";
        songDir = "";
    ...
    /**
     * Shows if the util.UnnamedMediaPlayerHolder
    ...
    /**
     * The start point of util.UnnamedMediaPlayerHolder Runnable when threaded.
     */
    @Override
    public void run() {
        isActive = true;
